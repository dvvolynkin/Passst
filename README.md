...
<p align="center">
  <a href="https://github.com/dvvolynkin/Passst/releases/latest/download/Passst-0.1.0-macos-universal.dmg"><strong>Download for macOS</strong></a>
  ·
...
<p align="center">
  ...
  <img alt="Universal 2" src="https://img.shields.io/badge/Universal%202-arm64%20%2B%20x86__64-315CF3?style=flat-square">
...
1. Download **Passst 0.1.0** from the [latest release](https://github.com/dvvolynkin/Passst/releases/latest).
...
```sh
scripts/package-app.sh release 0.1.0 1
```
